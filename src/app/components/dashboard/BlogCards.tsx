// src/app/components/dashboard/BlogCards.tsx
'use client';
            ...
            <Link href={item.url} className='group'>
              <div className='rounded-lg dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-0 relative w-full break-words overflow-hidden'>
                <div className='relative'>
                  ...
                  <Badge color={'muted'} className='absolute bottom-5 end-5 font-semibold'>
                    {item.read}
                  </Badge>
                </div>
                ...
                <div className='px-6 pb-6'>
                  ...
                  <div className='flex'>
                    ...
                    <div className='flex gap-1 items-center ms-auto'>
                      <TbPoint size={15} className='text-dark' /> <span className='text-sm text-darklink'>{item.time}</span>
                    </div>
                  </div>
                </div>
              </div>
