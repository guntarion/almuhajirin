// src/app/components/dashboard/TotalFollowers.tsx
'use client';
...
const TotalFollowers = () => {
  ...
  const ChartData: any = {
    ...
    colors: ['var(--color-error)', 'var(--color-black, rgba(17, 28, 45, 0.10))'],
    plotOptions: {
      bar: {
        horizontal: false,
        columnWidth: '30%',
      ...
      <div className='bg-lighterror rounded-lg p-6 relative w-full break-words'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center gap-3'>
            ...
            <h5 className='text-base opacity-70'>Total Inovator NPS</h5>
          </div>
          <div>
            <Dropdown
              label=''
        ...
        <div className='grid grid-cols-12 gap-[24px] items-end mt-3'>
          ...
          <div className='xl:col-span-6  col-span-5 '>
            <div className='rounded-bars md:ps-7'>
              <Chart options={ChartData} series={ChartData.series} type='bar' height='100px' width='100%' />
            </div>
          </div>
        </div>
      </div>
