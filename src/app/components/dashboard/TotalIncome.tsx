// src/app/components/dashboard/TotalIncome.tsx
'use client';
      ...
      <div className='bg-lightsecondary rounded-lg p-6 relative w-full break-words'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center gap-3'>
            ...
            <h5 className='text-base opacity-70'>Total Penghematan</h5>
          </div>
          <div>
            <Dropdown
              label=''
        ...
        <div className='grid grid-cols-12 gap-[24px] items-end mt-10'>
          <div className='xl:col-span-6 col-span-7'>
            <h2 className='text-2xl mb-3'>Rp 6.28 T</h2>
          ...
          <div className='xl:col-span-6  col-span-5 '>
            <div className='rounded-bars md:ps-7'>
              <Chart options={ChartData} series={ChartData.series} type='area' height='70px' width='100%' />
            </div>
          </div>
        </div>
      </div>
